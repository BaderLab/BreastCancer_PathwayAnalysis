...
/**
 * Reads netCDF files into txt file representation in chunks of 1000 snps per chunk
 * Author: Shirley Hui
 * Date: Sep 20, 2016
 * Time: 1:19:40 PM
 */
public class NetCDFData {
    ...
    private final static String ROOT_DIR = "/home/shirleyhui/Work/BreastCancer_PathwayAnalysis/ERNeg/";
    ...
    public List[] getSnpIndexList(String chr, String type)
    {
        ...
        try
        {
            String filename = ROOT_DIR + "snps_to_genes_brca1.bcacerneg.ma.imp.all.breast-HISTONES-p5e-2.predicted.targets.qcsnpsexcluded.txt";
            ...
            if (type.equals("onco"))
                filename = ROOT_DIR + "data/brca1_onco/onco_brca1_info_chr"+chr+"_varid.txt";
            else if (type.equals("icogs"))
                filename = ROOT_DIR + "data/brca1_icogs/icogs_brca1_info_chr"+chr+"_varid.txt";
    ...
    public HashMap getSampleIndexMap(String type)
    {
        ...
        try
        {
            String filename = ROOT_DIR + "data/sample_orders/brca1_"+type+"_sample_ix_status.txt";
    ...
    public void writeChunk(int incr, String chr, String type, String range, int startIx)
    {
        try
        {
            ...
            List[] retList = getSnpIndexList(chr, type);
            ...
            String filename = ROOT_DIR + "data/brca1_"+type+"/"+type+"_brca1_imputed_chr"+chr+".nc";
            ...
            for (int i = 0; i < ixSubList.size();i++)
            {
                ...
                {
                    String sampleId = (String)sampleMap.get(j);
                    if (sampleId == null)
                        continue;
            ...
            String outfilename = ROOT_DIR + "geno/brca1_"+type + "/"+range+"/"+type+"_brca1_imputed_chr"+chr+"_"+range+"-"+endIx+".txt";
        ...
        try
        {
            ...
            while(!stop)
            {
                ...
                for (int i = 0; i < ixSubList.size();i++)
                {
                    ...
                    num= num +1;
                    int numSamples =0;
                    //System.out.println("Shape num: " + shape0[0]);
                    for (int j = 0; j < shape0[0]; j++)
                    {
                        int ixx = (j+1);
                        ...
                        if (sampleId == null)
                        {
                            //System.out.println("sample Id is null: " + (ixx));
                            continue;
                        }
    ...
    public void readTest()
    {
        try
        {
            String filename = ROOT_DIR + "data/brca1_onco/onco_brca1_imputed_chr1.nc";
    ...
    public static void main(String[] args)
    {
        ...
        //System.out.println("Writing chunks of size: " + incr);// + "), starting at: " + startIx);
