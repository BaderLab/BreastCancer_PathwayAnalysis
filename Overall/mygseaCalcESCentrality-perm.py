...
PATHWAY_FILE = '../Human_GOBP_AllPathways_no_GO_iea_April_01_2017_symbol.gmt'
SNPDISTMAP = '../snps_to_genes_all.meta.gwas.icogs.oncoarray.overall.nogenomiccontrol1-HISTONES-5e-2.predicted.targets.qcsnpsexcluded.txt'
